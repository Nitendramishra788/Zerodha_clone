        ...
        <div className='container p-5'>
            <div className='row p-5'>
                <div className='col text-center'>
                    <h3 className='p-2 mt-5'>We pioneered the discount broking model in India.</h3>
                    <h3 className=' mb-5'>Now, we are breaking ground with our technology.</h3>
                    <hr className='p-5 mt-5'></hr>
                </div>
            </div>
