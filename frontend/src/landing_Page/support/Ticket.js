...
function Ticket() {
    return ( 
        ...
        <div className='container'>
            <div className='row'>
                <h3 className='p-5'>To create a tickket, select relevant topic</h3>
                <div className='col'><h6 ><i class="fa-solid fa-plus"></i>Account Opening</h6>
                 ...
                 <div className='col'><h6><i class="fa-solid fa-user"></i>Your Zerodha Account</h6>
                  ...
                  <div className='col'><h6><i class="fa-solid fa-chart-column"></i>Your Zerodha Account</h6>
            ...
            <div className='row p-4'>
                <div className='col'><h6><i class="fa-regular fa-credit-card"></i>Funds</h6>
                <ul style={{listStyle:"none" , lineHeight:"40px"}}>
                ...
                <div className='col'><h6><i class="fa-regular fa-circle"></i>Console</h6>
                    <ul style={{listStyle:"none" , lineHeight:"40px"}}>
                ...
                <div className='col'><h6><i class="fa-regular fa-circle"></i>Coin</h6>
